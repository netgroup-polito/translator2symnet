...
//aggiunta livello 7
 ...
 //Application header offsets
  val ApplicationProtoOffset = 0
  val ApplicationProto = L7Tag + ApplicationProtoOffset
  val BodyOffset = 8
  val Body=L7Tag + BodyOffset
  val EmailFromOffset=16
  val EmailFrom = L7Tag + EmailFromOffset
